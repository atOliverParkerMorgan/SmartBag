...
*/
package com.olivermorgan.ontimev2.main.BakalariAPI.rozvrh.items;
...
//        }
    ...
    /**
     * Prefer because that one also checks the next week if the time cannot be determine from the current one.
     * <p>
